...
abstract class LogFormat
{
    ...
    /**
     * @param string $logPrefix Prefix of log filename
     */
    public function __construct($logPrefix)
    {
    ...
    abstract public function getLogFileNameFromDate($date);

    abstract public function isValidLogFilename($filename);

    abstract public function logFileNameToDate($filename);

    abstract public function lineAsHtml($line, $i, $channel);

    // http://yellow5.us/journal/server_side_text_linkification/
    public function linkifyText($sText, $aAttributes = null, $aProtocols = null, $aSubdomains = null)
    {
        // Defaults
